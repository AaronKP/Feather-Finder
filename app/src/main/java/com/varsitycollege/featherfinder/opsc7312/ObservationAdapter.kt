...
class ObservationAdapter(private val observationsList: ArrayList<Data.Observation>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.observation_list, parent, false)
